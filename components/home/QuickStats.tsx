...
import { Trophy, Users, Ticket, Flag } from 'lucide-react-native';

const QUICK_ACTIONS = [
    { id: 'standings', label: 'Classement', icon: Trophy, color: '#f59e0b' },
    { id: 'teams', label: 'Écuries', icon: Users, color: '#3b82f6' },
    { id: 'tickets', label: 'Billets', icon: Ticket, color: '#ef4444' },
    { id: 'drivers', label: 'Pilotes', icon: Flag, color: '#10b981' },
];
